...
codificacion: $(CARPETA_RECURSOS)/text.properties $(CARPETA_RECURSOS)/text_en.properties

$(CARPETA_RECURSOS)/text.properties: $(CARPETA_RECURSOS)/text.properties.utf8
	native2ascii -encoding UTF-8 $< $@

$(CARPETA_RECURSOS)/text_en.properties: $(CARPETA_RECURSOS)/text_en.properties.utf8
	native2ascii -encoding UTF-8 $< $@
